...
class lookBookColumn {
  constructor(isEditMode, cols) {
    ...
    this.defaultColDef = field => ({
      ...
      sortable: true,
      ...lookBookFilters.chooseAptFilter(field.dataType),
            ...
            return {
              ...
              cellRendererFramework: params => {
                return (
                  ...
                  >
                    <img
                      src={params.value || AppConstants.ICON.IMAGE}
                      width="40"
                      alt="logo"
                    />
                  </div>
            ...
            return {
              ...
              cellRendererFramework: params => {
                return (
                  <Link
                    to={{
                      pathname: ROUTE_URLS.NEW_LOOK_BOOK_URL,
                      state: {
                        isEditMode: true,
                        rowData: params.data
                      }
...
const lookBookFilters = new FilterOptions({
  collection: "look"
});

export default lookBookColumn;
