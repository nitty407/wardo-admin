...
class trendingServicesColumn {
  constructor(isEditMode, cols) {
    ...
    this.defaultColDef = field => ({
      ...
      sortable: true,
      ...trendingServicesFilters.chooseAptFilter(field.dataType),
...
const trendingServicesFilters = new FilterOptions({
  collection: "trending-services"
});

export default trendingServicesColumn;
