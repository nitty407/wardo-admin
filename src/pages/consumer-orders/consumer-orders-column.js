...
class consumerOrdersColumn {
  constructor(isEditMode, cols) {
    ...
    this.defaultColDef = field => ({
      ...
      sortable: true,
      ...consumerOrdersFilters.chooseAptFilter(field.dataType),
...
const consumerOrdersFilters = new FilterOptions({
  collection: "booking"
});

export default consumerOrdersColumn;
