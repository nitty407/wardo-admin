...
class stylistsColumn {
  constructor(isEditMode, cols) {
    ...
    this.defaultColDef = field => ({
      ...
      sortable: true,
      ...stylistsFilters.chooseAptFilter(field.dataType),
...
const stylistsFilters = new FilterOptions({
  collection: "stylist-package"
});

export default stylistsColumn;
